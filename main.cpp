...
int main() {
    ...
    opDesc.colpointer_matrix_b_init = "/workspace/sstStonne/tests/outerproduct/outerproduct_gemm_colpointerB.in";

    std::string hardware_configuration = "/workspace/sstStonne/tests/sparseflex_op_128mses_128_bw.cfg";
